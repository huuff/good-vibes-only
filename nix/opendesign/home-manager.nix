# Home Manager module for the officially released OpenDesign source.
# Intended for individual developers. Linux uses systemd --user units;
...
#   imports = [ inputs.good-vibes-only.homeManagerModules.open-design ];
