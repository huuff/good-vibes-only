...
function AppInner() {
  ...
  // up. Re-apply whenever either saved appearance preference changes.
  ...
  // Cloud authentication failures never redirect the local-only app. Local
  // CLI and BYOK workspaces remain usable regardless of hosted account state.
